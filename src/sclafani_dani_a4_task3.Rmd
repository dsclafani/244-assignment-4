...
### Data Wrangling
```{r}
#reading in the dataset I made from the ucsb pdf
...
We can expect that 95% of calculated confidence intervals calculated will contain the true proportion of UCSB nonbinrary/genderqueer students experienced exclusionary conduct according to the 2014 Campus Climate Report. 
