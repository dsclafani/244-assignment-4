...
### Data Visualization, Wild Fish Caught over time
...
ggplot(data = fish_complete, aes(x = time, y =wild_catch))+
  ...
  geom_line(aes(x = time, y = fish_predict), color = "green")+
  theme_minimal()+
  labs(x = "Time (years)", y= "Wild Fish Caught (million of tons)", title = "Wild Fish Caught over time Predicted catch versus \n actual catch (million of tons)")+
  theme(plot.title = element_text(hjust = 0.5))
```
